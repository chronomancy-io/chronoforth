...
cr .( compile wordlist..) include wordlist
...
cr .( compile labels..) include labels
cr .( compile doloop..) include doloop
cr .( compile sys..) include sys
cr .( compile debug..) include debug
cr .( compile ls..) include ls
cr .( compile require..) include require
cr .( compile open..) include open
cr .( compile accept..) include accept
cr .( compile v..) include v
